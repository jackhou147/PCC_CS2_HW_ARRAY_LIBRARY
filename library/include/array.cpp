...
void display_menu() {
    ...
    if (DEBUG)
        cout << endl << "-------------display_menu---------------" << endl;

    /*-------------process--------------*/
    cout << endl << "------------------------------------------------------------------------" << endl << "[A]ppend [B]efore a[F]ter [R]andom [D]elete [S]earch" << endl << "     re[V]erse [U]nique [<]Descending [>]Ascending" << endl << ".   .   .   .   .   .   .   .   .   .   .   .   .   .   .   .   ." << endl << "         [?]menu    [N]ext   [P]rev    e[X]it" << endl << "------------------------------------------------------------------------" << endl;
}
void display_array_info(int cursor, int num_used) {
    ...
    const bool DEBUG = false;
    if (DEBUG)
        cout << endl << "-------------display_array_info---------------" << endl;
...
string error_description(ERRORS code) {
    ...
    const bool DEBUG = false;
    if (DEBUG)
        cout << endl << "-------------error_description---------------" << endl;
...
void display_array_nav(ITEM_TYPE a[], int num_used, int cursor, ERRORS & error) {
    ...
    const bool DEBUG = false;
    if (DEBUG)
        cout << endl << "-------------display_array_nav---------------" << endl << "error: " << error << "; " << error_description(error) << endl;
...
ERRORS shift_right(ITEM_TYPE a[],
    ...
    const bool DEBUG = false;
    if (DEBUG)
        cout << endl << "-------------shift_right---------------" << endl << "num_used: " << num_used << "; mark: " << mark << endl;
...
ERRORS insert_before(ITEM_TYPE a[],
    ...
    const bool DEBUG = false;
    if (DEBUG)
        cout << endl << "-------------insert_before---------------" << endl << "num_used: " << num_used << "; mark:" << mark << endl;
...
ERRORS remove(ITEM_TYPE a[],
    ...
    const bool DEBUG = false;
    if (DEBUG)
        cout << endl << "-------------arr_remove---------------" << endl << "num_used: " << num_used << "; mark: " << mark << endl;
